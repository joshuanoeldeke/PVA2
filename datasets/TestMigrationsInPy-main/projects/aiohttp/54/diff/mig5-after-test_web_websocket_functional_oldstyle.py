...
from aiohttp._ws_impl import WSMsgType, WebSocketParser, WebSocketWriter
...
@asyncio.coroutine
def test_server_close_handshake_server_eats_client_messages(create_server, connect_ws, loop):
    ...
    response, reader, writer = yield from connect_ws(url, 'eggs, bar')
